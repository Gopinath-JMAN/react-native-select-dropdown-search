        ...
        if (text.length > 0 && !autoComplete) {
          const defaultFilterFunction = (e: any) => {
            ...
            const key = text
              ...
              .normalize('NFD')
              .replace(/[\u0300-\u036f]/g, '');
            let split_text = item.split(' ');
            // if (split_text.length > 1) {
            //   for (let i = 0; i < split_text.length; i++) {
            //     if (split_text[i].indexOf(key) == 0) {
            //       return true;
            //     }
            //   }
            // } else {
      ...
      if (search) {
          ...
          return (
            <View style={{
              ...
              <TouchableOpacity onPress={() => setVisible(false)}>
                <Text style={{ fontSize: 16, color: '#2779f5' }}>Cancel</Text>
        ...
        return (
          <View style={{
            ...
            <Text style={{ fontSize: 16, color: '#000000', fontWeight: 'bold', width: '80%', paddingLeft: 10 }}>{placeholder ? placeholder : 'Select'}</Text>
            <TouchableOpacity onPress={() => setVisible(false)}>
              <Text style={{ fontSize: 16, color: '#2779f5' }}>Cancel</Text>
            </TouchableOpacity></View>
        );
        ...
        const _renderListHelper = () => {
          return (
            <FlatList
              ...
              // data={listData}
              data={_.orderBy(listData, (obj) => obj[labelField], 'desc')}
